        ...
        <div className='leftside-container'>
            ...
            <section className='social-links'>
                <div className='social-links-icons'>
                    <a href='https://github.com/Lopez4163' target='_blank'><i className="fa-brands fa-github"></i></a>
                    <a href='www.linkedin.com/in/nicholas-lopez-83b031299' target='_blank'><i className="fa-brands fa-linkedin"></i></a>
                    <a href='https://www.instagram.com/nickk_adre/' target='_blank'><i className="fa-brands fa-instagram"></i></a>
                </div>
            </section>
        </div>
    )
